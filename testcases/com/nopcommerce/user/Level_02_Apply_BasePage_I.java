 ...
 * 
 * public class Level_02_Apply_BasePage_I { WebDriver driver; String
 * emailAddress; // Declare (Khai báo) BasePage basePage; // BasePage: Class //
 * basePage: Object String projectPath = System.getProperty("user.dir");
 * 
 * @BeforeClass public void beforeClass() {
 * System.setProperty("webdriver.gecko.driver", projectPath +
 * "\\browserDrivers\\geckodriver.exe"); driver = new FirefoxDriver();
 * 
 * // Initial (Khởi tạo) basePage = new BasePage();
 * 
 ...
 * 
 * @Test public void TC_03_Register_Invalid_Success() {
 * basePage.waitForElementClickable(driver, "//a[@class='ico-register']");
 * basePage.clickToElement(driver, "//a[@class='ico-register']");
 * 
 * basePage.sendkeyToElement(driver, "//input[@id='FirstName']", "Automation");
 ...
 * 
 * public int generateFakeNumber() { Random rand = new Random(); return
 * rand.nextInt(9999); }
 * 
 * }
 */