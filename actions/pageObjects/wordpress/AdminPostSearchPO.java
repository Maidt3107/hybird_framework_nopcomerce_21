...
public class AdminPostSearchPO extends BasePage {
	...
	public boolean isPostSearchTableDisplayed(String hearderID, String cellValue) {
		int headerIndex = getElementSize(driver, AdminPostSearchPageUI.TABLE_HEADER_INDEX_BY_HEADER_NAME, hearderID) + 1;
	...
	public AdminPostAddNewPO clickToPostTitleLink(String postTitle) {
		waitForElementClickable(driver, AdminPostSearchPageUI.ROW_TITLE_DETAIL_TITLE_NAME,postTitle);
		clickToElement(driver, AdminPostSearchPageUI.ROW_TITLE_DETAIL_TITLE_NAME,postTitle);
		return PageGeneratorManager.getAdminPostAddNewPage(driver);
	}
